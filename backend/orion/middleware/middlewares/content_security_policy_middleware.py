    ...
    async def dispatch(self, request: Request, call_next):
        ...
        if request.url.path.startswith("/admin"):
            ...
            response.headers["Content-Security-Policy"] = ("default-src 'self' data: blob:; "
                                                           ...
                                                           "style-src-elem 'self' 'unsafe-inline' https://js.arcgis.com; "
                                                           "style-src-attr 'unsafe-inline'; "
                                                           "img-src 'self' data: blob: https://tiles.openfreemap.org https://*.arcgis.com https://*.arcgisonline.com; "
                                                           "font-src 'self' data: https://js.arcgis.com; "
                                                           "connect-src 'self' blob: https://tiles.openfreemap.org https://js.arcgis.com https://*.arcgis.com https://*.arcgisonline.com; "
                                                           "media-src 'self' data: blob:; "
                                                           "worker-src 'self' blob:; "
                                                           "child-src 'self' blob:; "
                                                           "frame-ancestors 'self'; "
